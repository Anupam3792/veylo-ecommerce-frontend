# 🛍️ Veylo — Frontend (React)

This is the **frontend** of Veylo, a full-stack e-commerce platform. It's a React application that provides the full shopping experience — browsing, cart, checkout, order tracking — plus a role-based admin dashboard.
