  ...
  return (
    <footer className="bg-ink text-paper mt-16 sm:mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-8 sm:gap-10">
        ...
        <div className="col-span-2">
          ...
          <div className="flex items-center gap-4 mt-4">
            <a
              href="#"
              aria-label="GitHub"
              className="text-xs text-paper/50 hover:text-verdant-light transition-colors"
            >
              GitHub
            </a>
        ...
        <div>
          <h3 className="text-[10px] sm:text-xs uppercase tracking-widest text-paper/40 mb-3">
            Shop
          </h3>
